...
print '''
\033[1;31m

\033[1;m
\033[1;31m
                    instahack-jilrot~#
code by @mohamadg80
\033[1;m
 ...
 \033[1;32m
===============================================
site    : https://jailbreakandroot.tk         |
channel : https://t.me/jailbreakandroot       |
channel : https://t.me/kali_Linuxxx           |
github  : https://github.com/jailbreakandroot |
===============================================
\033[1;m
'''
#Help function
...
instabrute = Instabrute(Input('username: jailbreakandroot~# '))
...
for password in instabrute.passwords:
	...
	if sess:
		...
		print ('[@jailbreakandroot] Password incorrect [%s]' % password)
